...
const translations = {
  'zh-CN': {
    ...
    inputPriceLabel: '普通输入价（每 M Tokens）',
    cachedInputPriceLabel: '缓存输入价（每 M Tokens）',
    outputPriceLabel: '输出价（每 M Tokens）',
    currencyLabel: '计价币种',
    usageSection: '每日用量',
    dailyInputLabel: '每日输入（M Tokens）',
    dailyCachedLabel: '其中缓存命中（M Tokens，可留空）',
    dailyOutputLabel: '每日输出（M Tokens，可留空）',
  ...
  en: {
    ...
    inputPriceLabel: 'Input price (per M tokens)',
    cachedInputPriceLabel: 'Cached input price (per M tokens)',
    outputPriceLabel: 'Output price (per M tokens)',
    currencyLabel: 'Pricing currency',
    usageSection: 'Daily usage',
    dailyInputLabel: 'Daily input (M tokens)',
    dailyCachedLabel: 'Cached input (M tokens, optional)',
    dailyOutputLabel: 'Daily output (M tokens, optional)',
